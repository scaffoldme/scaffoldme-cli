...
export declare function isValidProject(configFile: IConfigScaffoldme): boolean;
export declare function isInstalledProject(configFile: IConfigScaffoldme): boolean;
